                            ...
                            <Row style={{ height: '100%', width: '100%' }}>
                                ...
                                <Route
                                    ...
                                    render={(props) => {
                                        ...
                                        }, 10); // otherwise on an initial load on '/details' the class of the messages container won't be updated because the element isn't yet rendered => the details column won't show, because the column will still be with span={24}
