                ...
                {this.state.messages.map(message => (
                    ...
                    >
                        <Skeleton loading={loading} avatar active>
                            <Card.Meta
                                avatar={
                                    <Avatar src={message.createdBy?.profilePicture} shape="square" size={45} alt="user profile image" />
                                }
                                // !!! change their styles so that this Meta can replace the bottom code with the Columns
